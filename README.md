...
Target: http://192.168.1.9/dvwa/login.php

Date of the scan: Thu, 16 Oct 2025 22:06:10 +0000. Scope of the scan: folder
Summary
Category 	Number of vulnerabilities found
Arquivo Backup 	0
Injeção cega de SQL 	0
Weak credentials 	0
Injeção de CRLF 	0
Content Security Policy Configuration 	1
Cross Site Request Forgery 	0
Arquivo potencialmente malicioso 	0
...
Vulnerability found in /dvwa/login.php
Description
HTTP Request
cURL command line
